defmodule Ledgr.Domains.MrMunchMe do
  ...
  def theme do
    %{
      sidebar_bg: "#3A2A1F",
      sidebar_text: "#FDF8F3",
      sidebar_hover: "#4D3A2E",
      primary: "#5C3D2E",
      primary_soft: "#F5E6D8",
      accent: "#D4956A",
      bg: "#FDF8F3",
      bg_surface: "#FFFAF5",
      border_subtle: "#F0E2D6",
      border_strong: "#E0CFC3",
      text_main: "#3A2A1F",
      text_muted: "#9C8578",
      btn_secondary_bg: "#F0E2D6",
      btn_secondary_text: "#3A2A1F",
      btn_secondary_hover: "#E5D5C7",
      btn_primary_hover: "#4D3328",
      shadow_color: "58, 42, 31",
      table_header_bg: "#FDF3ED",
      gradient_start: "#F5E6D8",
      gradient_mid: "#FDF8F3",
      gradient_end: "#FFFAF5",
      ct_font_headline: "Manrope",
      ct_surface: "#FDF8F3",
      ct_surface_container: "#FFFAF5",
      ct_surface_container_high: "#FDF3ED",
      ct_on_surface: "#3A2A1F",
      ct_on_surface_variant: "#9C8578",
      ct_outline_variant: "#F0E2D6",
      ct_primary_container: "#5C3D2E",
      ct_primary_fixed: "#F5E6D8",
      ct_secondary_container: "#F0E2D6",
