...
config :ledgr,
  ecto_repos: [Ledgr.Repos.MrMunchMe, Ledgr.Repos.Viaxe, Ledgr.Repos.VolumeStudio],
  generators: [timestamp_type: :utc_datetime],
  domain: Ledgr.Domains.MrMunchMe,
  domains: [Ledgr.Domains.MrMunchMe, Ledgr.Domains.Viaxe, Ledgr.Domains.VolumeStudio],
