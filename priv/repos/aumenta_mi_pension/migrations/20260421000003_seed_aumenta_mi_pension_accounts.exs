defmodule Ledgr.Repos.AumentaMiPension.Migrations.SeedAumentaMiPensionAccounts do
  use Ecto.Migration

  @doc """
  Seeds the Aumenta Mi Pensión chart of accounts. Codes match
  `Ledgr.Domains.AumentaMiPension.account_codes/0`.
  ...
  def up do
    ...
    accounts = [
      ...
      # Liabilities
      %{code: "2000", name: "Agent Payable", type: "liability", normal_balance: "credit", is_cash: false, is_cogs: false},
